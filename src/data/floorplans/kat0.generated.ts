...
export const KAT0_DATASET: FloorPlanDataset = {
  ...
  edges: [
    ...
    {from: 'N2', to: 'N12', meters: 4.3, corridor: 'Ust koridor', instruction: 'Ana koridorda bati yonune ilerleyin.'},
    ...
    {from: 'N6', to: 'N12', meters: 7.9, corridor: 'Ana koridor orta gecis', instruction: 'Ana koridorda bati yonune ilerleyin.'},

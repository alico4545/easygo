...
export const KAT0_DATASET: FloorPlanDataset = {
  ...
  edges: [
    ...
    {from: 'N3', to: 'N13', meters: 4.7, corridor: 'Ust ana koridor', instruction: 'Sola donup ogretmenler odasi hattina ilerleyin.'},
    {from: 'N13', to: 'N2', meters: 4.8, corridor: 'Ust ana koridor', instruction: 'Koridorun orta noktasina ilerleyin.'},
    {from: 'N2', to: 'N12', meters: 4.3, corridor: 'Ust koridor', instruction: 'Depo kapisi hattina ilerleyin.'},
    {from: 'N12', to: 'N11', meters: 5.0, corridor: 'Ust koridor', instruction: 'Kutuphane kapisi hattina ilerleyin.'},
    {from: 'N11', to: 'N9', meters: 4.5, corridor: 'Ust koridor sol kol', instruction: 'Koridorun sol ucuna ilerleyin.'},
    ...
    {from: 'N5', to: 'N6', meters: 2.6, corridor: 'Sag alt koridor kose gecisi', instruction: 'Koridor kosesinden sola donup WC Erkek hattina baglanin.'},
    {from: 'N6', to: 'N13', meters: 4.6, corridor: 'Sag ust gecis', instruction: 'WC Erkek kosesinden yukari cikarak Ogretmenler kapisi hattina ilerleyin.'},
    {from: 'N6', to: 'N12', meters: 7.9, corridor: 'Ana koridor orta gecis', instruction: 'Ana koridorda bati yonune ilerleyip Depo hattina gecin.'},

...
export const KAT0_DATASET: FloorPlanDataset = {
  ...
  edges: [
    ...
    {from: 'N3', to: 'N4', meters: 4.0, corridor: 'Merdiven bağlantısı', instruction: 'Merdivenlerden güney yönünde ilerleyin.'},
    ...
    {from: 'N4', to: 'N5', meters: 7.0, corridor: 'Yükselti geçişi', instruction: 'Güney yönünde dümdüz ilerleyin.'},
    {from: 'N5', to: 'N10', meters: 14.7, corridor: 'Arka çıkış koridoru', instruction: 'Güney yönünde dümdüz ilerleyin.'},
